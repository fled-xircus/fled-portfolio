    ...
    <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
      ...
      <Box>
        ...
        <Text fontSize={{ base: 'md', md: 'xl' }}>
          I'm a skilled computer engineer with a passion for web design. With expertise in front-end development,
          I create visually appealing, user-friendly websites that meet client needs and industry standards. I'm committed to continuous
